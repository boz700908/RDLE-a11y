...
- [5. 外部编辑器（RDEventEditorHelper）](#5-外部编辑器（rdeventeditorhelper）)
  - [5.1 这是什么？](#51-这是什么？)
  - [5.2 怎么用？](#52-怎么用？)
- [6. 已知问题与局限](#6-已知问题与局限)
- [7. 常见问题](#7-常见问题)
  ...
  - [为什么我退出关卡编辑器的时候，在是否保存的对话框里点了取消，结果所有编辑器原生快捷键全部失灵了？](#为什么我退出关卡编辑器的时候，在是否保存的对话框里点了取消，结果所有编辑器原生快捷键全部失灵了？)
- [8. 附录](#8-附录)
...
| shift+0 | 打开/关闭标签模式 | mod 暂时对标签模式支持比较有限。目前， 在该模式下，当使用光标键浏览事件时，mod 不再朗读事件位置，而是朗读事件的标签。 |
| esc | 退出全屏/取消选择 | 无 |
